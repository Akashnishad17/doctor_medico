    ...
    -->
      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="{{ 'patient' == request()->path() ? 'active' : '' }}">
            <a href="/patient">
              <i class="now-ui-icons design_app"></i>
              <p>Dashboard</p>
            </a>
          ...
          <li class="{{ 'get-appointment' == request()->path() ? 'active' : '' }}">
          ...
          <li class="{{ 'show-appointment' == request()->path() ? 'active' : '' }}">
            <a href="/show-appointment">
              <i class="now-ui-icons text_caps-small"></i>
              <p>My Appointment</p>
            </a>
          </li>
          ...
          <li class="{{ 'doctor' == request()->path() ? 'active' : '' }}">
            <a href="/doctor">
              <i class="now-ui-icons design_app"></i>
              <p>Dashboard</p>
            </a>
